...
main (int argc, char *argv[])
{
  ...
  plot_setfillcolor(graph, 130, 130, 0);

  // Draw some filled shapes
  plot_setlinestart(graph, 10, 10);
  plot_addlinesegment(graph, 110, 10);
  plot_addlinesegment(graph, 110, 110);
  plot_addlinesegment(graph, 10, 110);
  plot_closeline(graph);
  plot_strokeline(graph);
  plot_fillline(graph);
  plot_endline(graph);

  plot_setlinestart(graph, 250, 120);
  plot_addlinesegment(graph, 300, 170);
  plot_addlinesegment(graph, 250, 220);
  plot_addlinesegment(graph, 200, 170);
  plot_closeline(graph);
  plot_strokeline(graph);
  plot_fillline(graph);
  plot_endline(graph);
  ...
  plot_setlinestart(graph, 10, 200);
  plot_addlinesegment(graph, 210, 200);
  plot_addlinesegment(graph, 210, 250);
  plot_addlinesegment(graph, 135, 250);
  plot_addlinesegment(graph, 135, 335);
  plot_addlinesegment(graph, 85, 335);
  plot_addlinesegment(graph, 85, 250);
  plot_addlinesegment(graph, 10, 250);
  plot_closeline(graph);
  plot_strokeline(graph);
  plot_fillline(graph);
  plot_endline(graph);
