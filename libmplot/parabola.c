...
main (int argc, char *argv[])
{
  ...
  // Draw the "frame" for the parabola
  plot_setlinestart (graph, 200, 200);
  plot_addcubiccurvesegment (graph, 300, 200, 225, 300, 275, 300);
  plot_strokeline (graph);
  plot_endline (graph);

  plot_setlinestart (graph, 200, 200);
  plot_addquadraticcurvesegmentone (graph, 300, 200, 200, 300);
  plot_strokeline (graph);
  plot_endline (graph);

  plot_setlinestart (graph, 200, 200);
  plot_addquadraticcurvesegmenttwo (graph, 300, 200, 300, 300);
  plot_strokeline (graph);
  plot_endline (graph);

  plot_setlinestart(graph, 200, 200);
  plot_addlinesegment(graph, 225, 300);
  plot_addlinesegment(graph, 275, 300);
  plot_addlinesegment(graph, 300, 200);
  plot_strokeline(graph);
  plot_endline(graph);
