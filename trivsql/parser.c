...
case 6:
#line 29 "parser.y"
{ tsql_rs *rs; tsql_doselect(gState, -1, NULL, (char *) yyvsp[-1], -1, NULL, rs); ;
    break;}
case 7:
#line 33 "parser.y"
{ yyval = tsql_xsnprintf("%s;%s", yyvsp[-2], yyvsp[0]); ;
    break;}
case 8:
#line 35 "parser.y"
{ yyval = tsql_xsnprintf("%s", yyvsp[0]); ;
    break;}
}
