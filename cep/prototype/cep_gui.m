...
load_handle = uicontrol('Parent',gui_handle, 'Callback','cep_callback(''Load'')', 'Units','pixels','Position',load_pos, 'String','Load','Tag','load_button','TooltipString','Load data from file');
