...
protected:
void cpt_mb_CARN_GPS_a_no_e_yes_x_yes_y_yes_z_yes_c (){runUI("mb_CARN_GPS -a no -e yes -x yes -y yes -z yes -c");}
void cpt_mb_CARN_GPS_a_no_e_yes_x_yes_y_yes_z_yes_m (){runUI("mb_CARN_GPS -a no -e yes -x yes -y yes -z yes -m");}
void cpt_mb_CARN_GPS_a_no_e_yes_x_yes_y_yes_z_no_c (){runUI("mb_CARN_GPS -a no -e yes -x yes -y yes -z no -c");}
void cpt_mb_CARN_GPS_a_no_e_yes_x_yes_y_yes_z_no_m (){runUI("mb_CARN_GPS -a no -e yes -x yes -y yes -z no -m");}
void cpt_mb_CARN_GPS_a_no_e_yes_x_yes_y_no_z_yes_c (){runUI("mb_CARN_GPS -a no -e yes -x yes -y no -z yes -c");}
void cpt_mb_CARN_GPS_a_no_e_yes_x_yes_y_no_z_yes_m (){runUI("mb_CARN_GPS -a no -e yes -x yes -y no -z yes -m");}
void cpt_mb_CARN_GPS_a_no_e_yes_x_yes_y_no_z_no_c (){runUI("mb_CARN_GPS -a no -e yes -x yes -y no -z no -c");}
void cpt_mb_CARN_GPS_a_no_e_yes_x_yes_y_no_z_no_m (){runUI("mb_CARN_GPS -a no -e yes -x yes -y no -z no -m");}
void cpt_mb_CARN_GPS_a_no_e_yes_x_no_y_yes_z_yes_c (){runUI("mb_CARN_GPS -a no -e yes -x no -y yes -z yes -c");}
void cpt_mb_CARN_GPS_a_no_e_yes_x_no_y_yes_z_yes_m (){runUI("mb_CARN_GPS -a no -e yes -x no -y yes -z yes -m");}
void cpt_mb_CARN_GPS_a_no_e_yes_x_no_y_yes_z_no_c (){runUI("mb_CARN_GPS -a no -e yes -x no -y yes -z no -c");}
void cpt_mb_CARN_GPS_a_no_e_yes_x_no_y_yes_z_no_m (){runUI("mb_CARN_GPS -a no -e yes -x no -y yes -z no -m");}
void cpt_mb_CARN_GPS_a_no_e_yes_x_no_y_no_z_yes_c (){runUI("mb_CARN_GPS -a no -e yes -x no -y no -z yes -c");}
void cpt_mb_CARN_GPS_a_no_e_yes_x_no_y_no_z_yes_m (){runUI("mb_CARN_GPS -a no -e yes -x no -y no -z yes -m");}
void cpt_mb_CARN_GPS_a_no_e_yes_x_no_y_no_z_no_c (){runUI("mb_CARN_GPS -a no -e yes -x no -y no -z no -c");}
void cpt_mb_CARN_GPS_a_no_e_yes_x_no_y_no_z_no_m (){runUI("mb_CARN_GPS -a no -e yes -x no -y no -z no -m");}
void cpt_mb_CARN_GPS_a_no_e_no_x_yes_y_yes_z_yes_c (){runUI("mb_CARN_GPS -a no -e no -x yes -y yes -z yes -c");}
void cpt_mb_CARN_GPS_a_no_e_no_x_yes_y_yes_z_yes_m (){runUI("mb_CARN_GPS -a no -e no -x yes -y yes -z yes -m");}
void cpt_mb_CARN_GPS_a_no_e_no_x_yes_y_yes_z_no_c (){runUI("mb_CARN_GPS -a no -e no -x yes -y yes -z no -c");}
void cpt_mb_CARN_GPS_a_no_e_no_x_yes_y_yes_z_no_m (){runUI("mb_CARN_GPS -a no -e no -x yes -y yes -z no -m");}
void cpt_mb_CARN_GPS_a_no_e_no_x_yes_y_no_z_yes_c (){runUI("mb_CARN_GPS -a no -e no -x yes -y no -z yes -c");}
void cpt_mb_CARN_GPS_a_no_e_no_x_yes_y_no_z_yes_m (){runUI("mb_CARN_GPS -a no -e no -x yes -y no -z yes -m");}
void cpt_mb_CARN_GPS_a_no_e_no_x_yes_y_no_z_no_c (){runUI("mb_CARN_GPS -a no -e no -x yes -y no -z no -c");}
void cpt_mb_CARN_GPS_a_no_e_no_x_yes_y_no_z_no_m (){runUI("mb_CARN_GPS -a no -e no -x yes -y no -z no -m");}
void cpt_mb_CARN_GPS_a_no_e_no_x_no_y_yes_z_yes_c (){runUI("mb_CARN_GPS -a no -e no -x no -y yes -z yes -c");}
void cpt_mb_CARN_GPS_a_no_e_no_x_no_y_yes_z_yes_m (){runUI("mb_CARN_GPS -a no -e no -x no -y yes -z yes -m");}
void cpt_mb_CARN_GPS_a_no_e_no_x_no_y_yes_z_no_c (){runUI("mb_CARN_GPS -a no -e no -x no -y yes -z no -c");}
void cpt_mb_CARN_GPS_a_no_e_no_x_no_y_yes_z_no_m (){runUI("mb_CARN_GPS -a no -e no -x no -y yes -z no -m");}
void cpt_mb_CARN_GPS_a_no_e_no_x_no_y_no_z_yes_c (){runUI("mb_CARN_GPS -a no -e no -x no -y no -z yes -c");}
void cpt_mb_CARN_GPS_a_no_e_no_x_no_y_no_z_yes_m (){runUI("mb_CARN_GPS -a no -e no -x no -y no -z yes -m");}
void cpt_mb_CARN_GPS_a_no_e_no_x_no_y_no_z_no_c (){runUI("mb_CARN_GPS -a no -e no -x no -y no -z no -c");}
void cpt_mb_CARN_GPS_a_no_e_no_x_no_y_no_z_no_m (){runUI("mb_CARN_GPS -a no -e no -x no -y no -z no -m");}
void cpt_mb_CAS1_GPS_a_yes_e_yes_x_yes_y_yes_z_yes_c (){runUI("mb_CAS1_GPS -a yes -e yes -x yes -y yes -z yes -c");}
void cpt_mb_CAS1_GPS_a_yes_e_yes_x_yes_y_yes_z_yes_m (){runUI("mb_CAS1_GPS -a yes -e yes -x yes -y yes -z yes -m");}
void cpt_mb_CAS1_GPS_a_yes_e_yes_x_yes_y_yes_z_no_c (){runUI("mb_CAS1_GPS -a yes -e yes -x yes -y yes -z no -c");}
void cpt_mb_CAS1_GPS_a_yes_e_yes_x_yes_y_yes_z_no_m (){runUI("mb_CAS1_GPS -a yes -e yes -x yes -y yes -z no -m");}
void cpt_mb_CAS1_GPS_a_yes_e_yes_x_yes_y_no_z_yes_c (){runUI("mb_CAS1_GPS -a yes -e yes -x yes -y no -z yes -c");}
void cpt_mb_CAS1_GPS_a_yes_e_yes_x_yes_y_no_z_yes_m (){runUI("mb_CAS1_GPS -a yes -e yes -x yes -y no -z yes -m");}
void cpt_mb_CAS1_GPS_a_yes_e_yes_x_yes_y_no_z_no_c (){runUI("mb_CAS1_GPS -a yes -e yes -x yes -y no -z no -c");}
void cpt_mb_CAS1_GPS_a_yes_e_yes_x_yes_y_no_z_no_m (){runUI("mb_CAS1_GPS -a yes -e yes -x yes -y no -z no -m");}
void cpt_mb_CAS1_GPS_a_yes_e_yes_x_no_y_yes_z_yes_c (){runUI("mb_CAS1_GPS -a yes -e yes -x no -y yes -z yes -c");}
void cpt_mb_CAS1_GPS_a_yes_e_yes_x_no_y_yes_z_yes_m (){runUI("mb_CAS1_GPS -a yes -e yes -x no -y yes -z yes -m");}
void cpt_mb_CAS1_GPS_a_yes_e_yes_x_no_y_yes_z_no_c (){runUI("mb_CAS1_GPS -a yes -e yes -x no -y yes -z no -c");}
void cpt_mb_CAS1_GPS_a_yes_e_yes_x_no_y_yes_z_no_m (){runUI("mb_CAS1_GPS -a yes -e yes -x no -y yes -z no -m");}
void cpt_mb_CAS1_GPS_a_yes_e_yes_x_no_y_no_z_yes_c (){runUI("mb_CAS1_GPS -a yes -e yes -x no -y no -z yes -c");}
void cpt_mb_CAS1_GPS_a_yes_e_yes_x_no_y_no_z_yes_m (){runUI("mb_CAS1_GPS -a yes -e yes -x no -y no -z yes -m");}
void cpt_mb_CAS1_GPS_a_yes_e_yes_x_no_y_no_z_no_c (){runUI("mb_CAS1_GPS -a yes -e yes -x no -y no -z no -c");}
void cpt_mb_CAS1_GPS_a_yes_e_yes_x_no_y_no_z_no_m (){runUI("mb_CAS1_GPS -a yes -e yes -x no -y no -z no -m");}
void cpt_mb_CAS1_GPS_a_yes_e_no_x_yes_y_yes_z_yes_c (){runUI("mb_CAS1_GPS -a yes -e no -x yes -y yes -z yes -c");}
void cpt_mb_CAS1_GPS_a_yes_e_no_x_yes_y_yes_z_yes_m (){runUI("mb_CAS1_GPS -a yes -e no -x yes -y yes -z yes -m");}
void cpt_mb_CAS1_GPS_a_yes_e_no_x_yes_y_yes_z_no_c (){runUI("mb_CAS1_GPS -a yes -e no -x yes -y yes -z no -c");}
void cpt_mb_CAS1_GPS_a_yes_e_no_x_yes_y_yes_z_no_m (){runUI("mb_CAS1_GPS -a yes -e no -x yes -y yes -z no -m");}
void cpt_mb_CAS1_GPS_a_yes_e_no_x_yes_y_no_z_yes_c (){runUI("mb_CAS1_GPS -a yes -e no -x yes -y no -z yes -c");}
void cpt_mb_CAS1_GPS_a_yes_e_no_x_yes_y_no_z_yes_m (){runUI("mb_CAS1_GPS -a yes -e no -x yes -y no -z yes -m");}
void cpt_mb_CAS1_GPS_a_yes_e_no_x_yes_y_no_z_no_c (){runUI("mb_CAS1_GPS -a yes -e no -x yes -y no -z no -c");}
void cpt_mb_CAS1_GPS_a_yes_e_no_x_yes_y_no_z_no_m (){runUI("mb_CAS1_GPS -a yes -e no -x yes -y no -z no -m");}
void cpt_mb_CAS1_GPS_a_yes_e_no_x_no_y_yes_z_yes_c (){runUI("mb_CAS1_GPS -a yes -e no -x no -y yes -z yes -c");}
void cpt_mb_CAS1_GPS_a_yes_e_no_x_no_y_yes_z_yes_m (){runUI("mb_CAS1_GPS -a yes -e no -x no -y yes -z yes -m");}
void cpt_mb_CAS1_GPS_a_yes_e_no_x_no_y_yes_z_no_c (){runUI("mb_CAS1_GPS -a yes -e no -x no -y yes -z no -c");}
void cpt_mb_CAS1_GPS_a_yes_e_no_x_no_y_yes_z_no_m (){runUI("mb_CAS1_GPS -a yes -e no -x no -y yes -z no -m");}
void cpt_mb_CAS1_GPS_a_yes_e_no_x_no_y_no_z_yes_c (){runUI("mb_CAS1_GPS -a yes -e no -x no -y no -z yes -c");}
void cpt_mb_CAS1_GPS_a_yes_e_no_x_no_y_no_z_yes_m (){runUI("mb_CAS1_GPS -a yes -e no -x no -y no -z yes -m");}
void cpt_mb_CAS1_GPS_a_yes_e_no_x_no_y_no_z_no_c (){runUI("mb_CAS1_GPS -a yes -e no -x no -y no -z no -c");}
void cpt_mb_CAS1_GPS_a_yes_e_no_x_no_y_no_z_no_m (){runUI("mb_CAS1_GPS -a yes -e no -x no -y no -z no -m");}
void cpt_mb_CAS1_GPS_a_no_e_yes_x_yes_y_yes_z_yes_c (){runUI("mb_CAS1_GPS -a no -e yes -x yes -y yes -z yes -c");}
void cpt_mb_CAS1_GPS_a_no_e_yes_x_yes_y_yes_z_yes_m (){runUI("mb_CAS1_GPS -a no -e yes -x yes -y yes -z yes -m");}
void cpt_mb_CAS1_GPS_a_no_e_yes_x_yes_y_yes_z_no_c (){runUI("mb_CAS1_GPS -a no -e yes -x yes -y yes -z no -c");}
void cpt_mb_CAS1_GPS_a_no_e_yes_x_yes_y_yes_z_no_m (){runUI("mb_CAS1_GPS -a no -e yes -x yes -y yes -z no -m");}
void cpt_mb_CAS1_GPS_a_no_e_yes_x_yes_y_no_z_yes_c (){runUI("mb_CAS1_GPS -a no -e yes -x yes -y no -z yes -c");}
void cpt_mb_CAS1_GPS_a_no_e_yes_x_yes_y_no_z_yes_m (){runUI("mb_CAS1_GPS -a no -e yes -x yes -y no -z yes -m");}
void cpt_mb_CAS1_GPS_a_no_e_yes_x_yes_y_no_z_no_c (){runUI("mb_CAS1_GPS -a no -e yes -x yes -y no -z no -c");}
void cpt_mb_CAS1_GPS_a_no_e_yes_x_yes_y_no_z_no_m (){runUI("mb_CAS1_GPS -a no -e yes -x yes -y no -z no -m");}
void cpt_mb_CAS1_GPS_a_no_e_yes_x_no_y_yes_z_yes_c (){runUI("mb_CAS1_GPS -a no -e yes -x no -y yes -z yes -c");}
void cpt_mb_CAS1_GPS_a_no_e_yes_x_no_y_yes_z_yes_m (){runUI("mb_CAS1_GPS -a no -e yes -x no -y yes -z yes -m");}
void cpt_mb_CAS1_GPS_a_no_e_yes_x_no_y_yes_z_no_c (){runUI("mb_CAS1_GPS -a no -e yes -x no -y yes -z no -c");}
void cpt_mb_CAS1_GPS_a_no_e_yes_x_no_y_yes_z_no_m (){runUI("mb_CAS1_GPS -a no -e yes -x no -y yes -z no -m");}
void cpt_mb_CAS1_GPS_a_no_e_yes_x_no_y_no_z_yes_c (){runUI("mb_CAS1_GPS -a no -e yes -x no -y no -z yes -c");}
void cpt_mb_CAS1_GPS_a_no_e_yes_x_no_y_no_z_yes_m (){runUI("mb_CAS1_GPS -a no -e yes -x no -y no -z yes -m");}
void cpt_mb_CAS1_GPS_a_no_e_yes_x_no_y_no_z_no_c (){runUI("mb_CAS1_GPS -a no -e yes -x no -y no -z no -c");}
void cpt_mb_CAS1_GPS_a_no_e_yes_x_no_y_no_z_no_m (){runUI("mb_CAS1_GPS -a no -e yes -x no -y no -z no -m");}
void cpt_mb_CAS1_GPS_a_no_e_no_x_yes_y_yes_z_yes_c (){runUI("mb_CAS1_GPS -a no -e no -x yes -y yes -z yes -c");}
void cpt_mb_CAS1_GPS_a_no_e_no_x_yes_y_yes_z_yes_m (){runUI("mb_CAS1_GPS -a no -e no -x yes -y yes -z yes -m");}
void cpt_mb_CAS1_GPS_a_no_e_no_x_yes_y_yes_z_no_c (){runUI("mb_CAS1_GPS -a no -e no -x yes -y yes -z no -c");}
void cpt_mb_CAS1_GPS_a_no_e_no_x_yes_y_yes_z_no_m (){runUI("mb_CAS1_GPS -a no -e no -x yes -y yes -z no -m");}
void cpt_mb_CAS1_GPS_a_no_e_no_x_yes_y_no_z_yes_c (){runUI("mb_CAS1_GPS -a no -e no -x yes -y no -z yes -c");}
void cpt_mb_CAS1_GPS_a_no_e_no_x_yes_y_no_z_yes_m (){runUI("mb_CAS1_GPS -a no -e no -x yes -y no -z yes -m");}
void cpt_mb_CAS1_GPS_a_no_e_no_x_yes_y_no_z_no_c (){runUI("mb_CAS1_GPS -a no -e no -x yes -y no -z no -c");}
void cpt_mb_CAS1_GPS_a_no_e_no_x_yes_y_no_z_no_m (){runUI("mb_CAS1_GPS -a no -e no -x yes -y no -z no -m");}
void cpt_mb_CAS1_GPS_a_no_e_no_x_no_y_yes_z_yes_c (){runUI("mb_CAS1_GPS -a no -e no -x no -y yes -z yes -c");}
void cpt_mb_CAS1_GPS_a_no_e_no_x_no_y_yes_z_yes_m (){runUI("mb_CAS1_GPS -a no -e no -x no -y yes -z yes -m");}
void cpt_mb_CAS1_GPS_a_no_e_no_x_no_y_yes_z_no_c (){runUI("mb_CAS1_GPS -a no -e no -x no -y yes -z no -c");}
void cpt_mb_CAS1_GPS_a_no_e_no_x_no_y_yes_z_no_m (){runUI("mb_CAS1_GPS -a no -e no -x no -y yes -z no -m");}
void cpt_mb_CAS1_GPS_a_no_e_no_x_no_y_no_z_yes_c (){runUI("mb_CAS1_GPS -a no -e no -x no -y no -z yes -c");}
void cpt_mb_CAS1_GPS_a_no_e_no_x_no_y_no_z_yes_m (){runUI("mb_CAS1_GPS -a no -e no -x no -y no -z yes -m");}
void cpt_mb_CAS1_GPS_a_no_e_no_x_no_y_no_z_no_c (){runUI("mb_CAS1_GPS -a no -e no -x no -y no -z no -c");}
void cpt_mb_CAS1_GPS_a_no_e_no_x_no_y_no_z_no_m (){runUI("mb_CAS1_GPS -a no -e no -x no -y no -z no -m");}
void cpt_mb_CEDU_GPS_a_yes_e_yes_x_yes_y_yes_z_yes_c (){runUI("mb_CEDU_GPS -a yes -e yes -x yes -y yes -z yes -c");}
void cpt_mb_CEDU_GPS_a_yes_e_yes_x_yes_y_yes_z_yes_m (){runUI("mb_CEDU_GPS -a yes -e yes -x yes -y yes -z yes -m");}
void cpt_mb_CEDU_GPS_a_yes_e_yes_x_yes_y_yes_z_no_c (){runUI("mb_CEDU_GPS -a yes -e yes -x yes -y yes -z no -c");}
void cpt_mb_CEDU_GPS_a_yes_e_yes_x_yes_y_yes_z_no_m (){runUI("mb_CEDU_GPS -a yes -e yes -x yes -y yes -z no -m");}
void cpt_mb_CEDU_GPS_a_yes_e_yes_x_yes_y_no_z_yes_c (){runUI("mb_CEDU_GPS -a yes -e yes -x yes -y no -z yes -c");}
void cpt_mb_CEDU_GPS_a_yes_e_yes_x_yes_y_no_z_yes_m (){runUI("mb_CEDU_GPS -a yes -e yes -x yes -y no -z yes -m");}
void cpt_mb_CEDU_GPS_a_yes_e_yes_x_yes_y_no_z_no_c (){runUI("mb_CEDU_GPS -a yes -e yes -x yes -y no -z no -c");}
void cpt_mb_CEDU_GPS_a_yes_e_yes_x_yes_y_no_z_no_m (){runUI("mb_CEDU_GPS -a yes -e yes -x yes -y no -z no -m");}
void cpt_mb_CEDU_GPS_a_yes_e_yes_x_no_y_yes_z_yes_c (){runUI("mb_CEDU_GPS -a yes -e yes -x no -y yes -z yes -c");}
void cpt_mb_CEDU_GPS_a_yes_e_yes_x_no_y_yes_z_yes_m (){runUI("mb_CEDU_GPS -a yes -e yes -x no -y yes -z yes -m");}
void cpt_mb_CEDU_GPS_a_yes_e_yes_x_no_y_yes_z_no_c (){runUI("mb_CEDU_GPS -a yes -e yes -x no -y yes -z no -c");}
void cpt_mb_CEDU_GPS_a_yes_e_yes_x_no_y_yes_z_no_m (){runUI("mb_CEDU_GPS -a yes -e yes -x no -y yes -z no -m");}
void cpt_mb_CEDU_GPS_a_yes_e_yes_x_no_y_no_z_yes_c (){runUI("mb_CEDU_GPS -a yes -e yes -x no -y no -z yes -c");}
void cpt_mb_CEDU_GPS_a_yes_e_yes_x_no_y_no_z_yes_m (){runUI("mb_CEDU_GPS -a yes -e yes -x no -y no -z yes -m");}
void cpt_mb_CEDU_GPS_a_yes_e_yes_x_no_y_no_z_no_c (){runUI("mb_CEDU_GPS -a yes -e yes -x no -y no -z no -c");}
void cpt_mb_CEDU_GPS_a_yes_e_yes_x_no_y_no_z_no_m (){runUI("mb_CEDU_GPS -a yes -e yes -x no -y no -z no -m");}
void cpt_mb_CEDU_GPS_a_yes_e_no_x_yes_y_yes_z_yes_c (){runUI("mb_CEDU_GPS -a yes -e no -x yes -y yes -z yes -c");}
void cpt_mb_CEDU_GPS_a_yes_e_no_x_yes_y_yes_z_yes_m (){runUI("mb_CEDU_GPS -a yes -e no -x yes -y yes -z yes -m");}
void cpt_mb_CEDU_GPS_a_yes_e_no_x_yes_y_yes_z_no_c (){runUI("mb_CEDU_GPS -a yes -e no -x yes -y yes -z no -c");}
void cpt_mb_CEDU_GPS_a_yes_e_no_x_yes_y_yes_z_no_m (){runUI("mb_CEDU_GPS -a yes -e no -x yes -y yes -z no -m");}
void cpt_mb_CEDU_GPS_a_yes_e_no_x_yes_y_no_z_yes_c (){runUI("mb_CEDU_GPS -a yes -e no -x yes -y no -z yes -c");}
void cpt_mb_CEDU_GPS_a_yes_e_no_x_yes_y_no_z_yes_m (){runUI("mb_CEDU_GPS -a yes -e no -x yes -y no -z yes -m");}
void cpt_mb_CEDU_GPS_a_yes_e_no_x_yes_y_no_z_no_c (){runUI("mb_CEDU_GPS -a yes -e no -x yes -y no -z no -c");}
void cpt_mb_CEDU_GPS_a_yes_e_no_x_yes_y_no_z_no_m (){runUI("mb_CEDU_GPS -a yes -e no -x yes -y no -z no -m");}
void cpt_mb_CEDU_GPS_a_yes_e_no_x_no_y_yes_z_yes_c (){runUI("mb_CEDU_GPS -a yes -e no -x no -y yes -z yes -c");}
void cpt_mb_CEDU_GPS_a_yes_e_no_x_no_y_yes_z_yes_m (){runUI("mb_CEDU_GPS -a yes -e no -x no -y yes -z yes -m");}
void cpt_mb_CEDU_GPS_a_yes_e_no_x_no_y_yes_z_no_c (){runUI("mb_CEDU_GPS -a yes -e no -x no -y yes -z no -c");}
void cpt_mb_CEDU_GPS_a_yes_e_no_x_no_y_yes_z_no_m (){runUI("mb_CEDU_GPS -a yes -e no -x no -y yes -z no -m");}
void cpt_mb_CEDU_GPS_a_yes_e_no_x_no_y_no_z_yes_c (){runUI("mb_CEDU_GPS -a yes -e no -x no -y no -z yes -c");}
void cpt_mb_CEDU_GPS_a_yes_e_no_x_no_y_no_z_yes_m (){runUI("mb_CEDU_GPS -a yes -e no -x no -y no -z yes -m");}
void cpt_mb_CEDU_GPS_a_yes_e_no_x_no_y_no_z_no_c (){runUI("mb_CEDU_GPS -a yes -e no -x no -y no -z no -c");}
void cpt_mb_CEDU_GPS_a_yes_e_no_x_no_y_no_z_no_m (){runUI("mb_CEDU_GPS -a yes -e no -x no -y no -z no -m");}
void cpt_mb_CEDU_GPS_a_no_e_yes_x_yes_y_yes_z_yes_c (){runUI("mb_CEDU_GPS -a no -e yes -x yes -y yes -z yes -c");}
void cpt_mb_CEDU_GPS_a_no_e_yes_x_yes_y_yes_z_yes_m (){runUI("mb_CEDU_GPS -a no -e yes -x yes -y yes -z yes -m");}
void cpt_mb_CEDU_GPS_a_no_e_yes_x_yes_y_yes_z_no_c (){runUI("mb_CEDU_GPS -a no -e yes -x yes -y yes -z no -c");}
void cpt_mb_CEDU_GPS_a_no_e_yes_x_yes_y_yes_z_no_m (){runUI("mb_CEDU_GPS -a no -e yes -x yes -y yes -z no -m");}
void cpt_mb_CEDU_GPS_a_no_e_yes_x_yes_y_no_z_yes_c (){runUI("mb_CEDU_GPS -a no -e yes -x yes -y no -z yes -c");}
void cpt_mb_CEDU_GPS_a_no_e_yes_x_yes_y_no_z_yes_m (){runUI("mb_CEDU_GPS -a no -e yes -x yes -y no -z yes -m");}
void cpt_mb_CEDU_GPS_a_no_e_yes_x_yes_y_no_z_no_c (){runUI("mb_CEDU_GPS -a no -e yes -x yes -y no -z no -c");}
void cpt_mb_CEDU_GPS_a_no_e_yes_x_yes_y_no_z_no_m (){runUI("mb_CEDU_GPS -a no -e yes -x yes -y no -z no -m");}
void cpt_mb_CEDU_GPS_a_no_e_yes_x_no_y_yes_z_yes_c (){runUI("mb_CEDU_GPS -a no -e yes -x no -y yes -z yes -c");}
void cpt_mb_CEDU_GPS_a_no_e_yes_x_no_y_yes_z_yes_m (){runUI("mb_CEDU_GPS -a no -e yes -x no -y yes -z yes -m");}
void cpt_mb_CEDU_GPS_a_no_e_yes_x_no_y_yes_z_no_c (){runUI("mb_CEDU_GPS -a no -e yes -x no -y yes -z no -c");}
void cpt_mb_CEDU_GPS_a_no_e_yes_x_no_y_yes_z_no_m (){runUI("mb_CEDU_GPS -a no -e yes -x no -y yes -z no -m");}
void cpt_mb_CEDU_GPS_a_no_e_yes_x_no_y_no_z_yes_c (){runUI("mb_CEDU_GPS -a no -e yes -x no -y no -z yes -c");}
void cpt_mb_CEDU_GPS_a_no_e_yes_x_no_y_no_z_yes_m (){runUI("mb_CEDU_GPS -a no -e yes -x no -y no -z yes -m");}
void cpt_mb_CEDU_GPS_a_no_e_yes_x_no_y_no_z_no_c (){runUI("mb_CEDU_GPS -a no -e yes -x no -y no -z no -c");}
void cpt_mb_CEDU_GPS_a_no_e_yes_x_no_y_no_z_no_m (){runUI("mb_CEDU_GPS -a no -e yes -x no -y no -z no -m");}
void cpt_mb_CEDU_GPS_a_no_e_no_x_yes_y_yes_z_yes_c (){runUI("mb_CEDU_GPS -a no -e no -x yes -y yes -z yes -c");}
void cpt_mb_CEDU_GPS_a_no_e_no_x_yes_y_yes_z_yes_m (){runUI("mb_CEDU_GPS -a no -e no -x yes -y yes -z yes -m");}
void cpt_mb_CEDU_GPS_a_no_e_no_x_yes_y_yes_z_no_c (){runUI("mb_CEDU_GPS -a no -e no -x yes -y yes -z no -c");}
void cpt_mb_CEDU_GPS_a_no_e_no_x_yes_y_yes_z_no_m (){runUI("mb_CEDU_GPS -a no -e no -x yes -y yes -z no -m");}
void cpt_mb_CEDU_GPS_a_no_e_no_x_yes_y_no_z_yes_c (){runUI("mb_CEDU_GPS -a no -e no -x yes -y no -z yes -c");}
void cpt_mb_CEDU_GPS_a_no_e_no_x_yes_y_no_z_yes_m (){runUI("mb_CEDU_GPS -a no -e no -x yes -y no -z yes -m");}
void cpt_mb_CEDU_GPS_a_no_e_no_x_yes_y_no_z_no_c (){runUI("mb_CEDU_GPS -a no -e no -x yes -y no -z no -c");}
void cpt_mb_CEDU_GPS_a_no_e_no_x_yes_y_no_z_no_m (){runUI("mb_CEDU_GPS -a no -e no -x yes -y no -z no -m");}
void cpt_mb_CEDU_GPS_a_no_e_no_x_no_y_yes_z_yes_c (){runUI("mb_CEDU_GPS -a no -e no -x no -y yes -z yes -c");}
void cpt_mb_CEDU_GPS_a_no_e_no_x_no_y_yes_z_yes_m (){runUI("mb_CEDU_GPS -a no -e no -x no -y yes -z yes -m");}
void cpt_mb_CEDU_GPS_a_no_e_no_x_no_y_yes_z_no_c (){runUI("mb_CEDU_GPS -a no -e no -x no -y yes -z no -c");}
void cpt_mb_CEDU_GPS_a_no_e_no_x_no_y_yes_z_no_m (){runUI("mb_CEDU_GPS -a no -e no -x no -y yes -z no -m");}
void cpt_mb_CEDU_GPS_a_no_e_no_x_no_y_no_z_yes_c (){runUI("mb_CEDU_GPS -a no -e no -x no -y no -z yes -c");}
void cpt_mb_CEDU_GPS_a_no_e_no_x_no_y_no_z_yes_m (){runUI("mb_CEDU_GPS -a no -e no -x no -y no -z yes -m");}
void cpt_mb_CEDU_GPS_a_no_e_no_x_no_y_no_z_no_c (){runUI("mb_CEDU_GPS -a no -e no -x no -y no -z no -c");}
void cpt_mb_CEDU_GPS_a_no_e_no_x_no_y_no_z_no_m (){runUI("mb_CEDU_GPS -a no -e no -x no -y no -z no -m");}
void cpt_mb_CENI_GPS_a_yes_e_yes_x_yes_y_yes_z_yes_c (){runUI("mb_CENI_GPS -a yes -e yes -x yes -y yes -z yes -c");}
void cpt_mb_CENI_GPS_a_yes_e_yes_x_yes_y_yes_z_yes_m (){runUI("mb_CENI_GPS -a yes -e yes -x yes -y yes -z yes -m");}
void cpt_mb_CENI_GPS_a_yes_e_yes_x_yes_y_yes_z_no_c (){runUI("mb_CENI_GPS -a yes -e yes -x yes -y yes -z no -c");}
void cpt_mb_CENI_GPS_a_yes_e_yes_x_yes_y_yes_z_no_m (){runUI("mb_CENI_GPS -a yes -e yes -x yes -y yes -z no -m");}
void cpt_mb_CENI_GPS_a_yes_e_yes_x_yes_y_no_z_yes_c (){runUI("mb_CENI_GPS -a yes -e yes -x yes -y no -z yes -c");}
void cpt_mb_CENI_GPS_a_yes_e_yes_x_yes_y_no_z_yes_m (){runUI("mb_CENI_GPS -a yes -e yes -x yes -y no -z yes -m");}
void cpt_mb_CENI_GPS_a_yes_e_yes_x_yes_y_no_z_no_c (){runUI("mb_CENI_GPS -a yes -e yes -x yes -y no -z no -c");}
void cpt_mb_CENI_GPS_a_yes_e_yes_x_yes_y_no_z_no_m (){runUI("mb_CENI_GPS -a yes -e yes -x yes -y no -z no -m");}
void cpt_mb_CENI_GPS_a_yes_e_yes_x_no_y_yes_z_yes_c (){runUI("mb_CENI_GPS -a yes -e yes -x no -y yes -z yes -c");}
void cpt_mb_CENI_GPS_a_yes_e_yes_x_no_y_yes_z_yes_m (){runUI("mb_CENI_GPS -a yes -e yes -x no -y yes -z yes -m");}
void cpt_mb_CENI_GPS_a_yes_e_yes_x_no_y_yes_z_no_c (){runUI("mb_CENI_GPS -a yes -e yes -x no -y yes -z no -c");}
void cpt_mb_CENI_GPS_a_yes_e_yes_x_no_y_yes_z_no_m (){runUI("mb_CENI_GPS -a yes -e yes -x no -y yes -z no -m");}
void cpt_mb_CENI_GPS_a_yes_e_yes_x_no_y_no_z_yes_c (){runUI("mb_CENI_GPS -a yes -e yes -x no -y no -z yes -c");}
void cpt_mb_CENI_GPS_a_yes_e_yes_x_no_y_no_z_yes_m (){runUI("mb_CENI_GPS -a yes -e yes -x no -y no -z yes -m");}
void cpt_mb_CENI_GPS_a_yes_e_yes_x_no_y_no_z_no_c (){runUI("mb_CENI_GPS -a yes -e yes -x no -y no -z no -c");}
void cpt_mb_CENI_GPS_a_yes_e_yes_x_no_y_no_z_no_m (){runUI("mb_CENI_GPS -a yes -e yes -x no -y no -z no -m");}
void cpt_mb_CENI_GPS_a_yes_e_no_x_yes_y_yes_z_yes_c (){runUI("mb_CENI_GPS -a yes -e no -x yes -y yes -z yes -c");}
void cpt_mb_CENI_GPS_a_yes_e_no_x_yes_y_yes_z_yes_m (){runUI("mb_CENI_GPS -a yes -e no -x yes -y yes -z yes -m");}
void cpt_mb_CENI_GPS_a_yes_e_no_x_yes_y_yes_z_no_c (){runUI("mb_CENI_GPS -a yes -e no -x yes -y yes -z no -c");}
void cpt_mb_CENI_GPS_a_yes_e_no_x_yes_y_yes_z_no_m (){runUI("mb_CENI_GPS -a yes -e no -x yes -y yes -z no -m");}
void cpt_mb_CENI_GPS_a_yes_e_no_x_yes_y_no_z_yes_c (){runUI("mb_CENI_GPS -a yes -e no -x yes -y no -z yes -c");}
void cpt_mb_CENI_GPS_a_yes_e_no_x_yes_y_no_z_yes_m (){runUI("mb_CENI_GPS -a yes -e no -x yes -y no -z yes -m");}
void cpt_mb_CENI_GPS_a_yes_e_no_x_yes_y_no_z_no_c (){runUI("mb_CENI_GPS -a yes -e no -x yes -y no -z no -c");}
void cpt_mb_CENI_GPS_a_yes_e_no_x_yes_y_no_z_no_m (){runUI("mb_CENI_GPS -a yes -e no -x yes -y no -z no -m");}
void cpt_mb_CENI_GPS_a_yes_e_no_x_no_y_yes_z_yes_c (){runUI("mb_CENI_GPS -a yes -e no -x no -y yes -z yes -c");}
void cpt_mb_CENI_GPS_a_yes_e_no_x_no_y_yes_z_yes_m (){runUI("mb_CENI_GPS -a yes -e no -x no -y yes -z yes -m");}
void cpt_mb_CENI_GPS_a_yes_e_no_x_no_y_yes_z_no_c (){runUI("mb_CENI_GPS -a yes -e no -x no -y yes -z no -c");}
void cpt_mb_CENI_GPS_a_yes_e_no_x_no_y_yes_z_no_m (){runUI("mb_CENI_GPS -a yes -e no -x no -y yes -z no -m");}
void cpt_mb_CENI_GPS_a_yes_e_no_x_no_y_no_z_yes_c (){runUI("mb_CENI_GPS -a yes -e no -x no -y no -z yes -c");}
void cpt_mb_CENI_GPS_a_yes_e_no_x_no_y_no_z_yes_m (){runUI("mb_CENI_GPS -a yes -e no -x no -y no -z yes -m");}
void cpt_mb_CENI_GPS_a_yes_e_no_x_no_y_no_z_no_c (){runUI("mb_CENI_GPS -a yes -e no -x no -y no -z no -c");}
void cpt_mb_CENI_GPS_a_yes_e_no_x_no_y_no_z_no_m (){runUI("mb_CENI_GPS -a yes -e no -x no -y no -z no -m");}
void cpt_mb_CENI_GPS_a_no_e_yes_x_yes_y_yes_z_yes_c (){runUI("mb_CENI_GPS -a no -e yes -x yes -y yes -z yes -c");}
void cpt_mb_CENI_GPS_a_no_e_yes_x_yes_y_yes_z_yes_m (){runUI("mb_CENI_GPS -a no -e yes -x yes -y yes -z yes -m");}
void cpt_mb_CENI_GPS_a_no_e_yes_x_yes_y_yes_z_no_c (){runUI("mb_CENI_GPS -a no -e yes -x yes -y yes -z no -c");}
void cpt_mb_CENI_GPS_a_no_e_yes_x_yes_y_yes_z_no_m (){runUI("mb_CENI_GPS -a no -e yes -x yes -y yes -z no -m");}
void cpt_mb_CENI_GPS_a_no_e_yes_x_yes_y_no_z_yes_c (){runUI("mb_CENI_GPS -a no -e yes -x yes -y no -z yes -c");}
void cpt_mb_CENI_GPS_a_no_e_yes_x_yes_y_no_z_yes_m (){runUI("mb_CENI_GPS -a no -e yes -x yes -y no -z yes -m");}
void cpt_mb_CENI_GPS_a_no_e_yes_x_yes_y_no_z_no_c (){runUI("mb_CENI_GPS -a no -e yes -x yes -y no -z no -c");}
